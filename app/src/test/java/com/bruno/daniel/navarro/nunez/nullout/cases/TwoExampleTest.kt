...
internal class TwoExampleTest {
    ...
    @Test
    fun example_two_with_out_NullOut_functions() {
        val objetoPrincipal = User()
        val valor1 = exampleClass.exampleTwoWithOutNullOut(objetoPrincipal)
        Assert.assertEquals(null, valor1)
    }

    @Test
    fun example_two_with_NullOut_functions() {
        val objetoPrincipal = User()
        val valor1 = exampleClass.exampleTwoWithNullOut(objetoPrincipal)
